...
driver_exe: str = os.path.join(os.path.dirname(__file__), 'chromedriver.exe')
...
def main_email_scraper():
    browser = Browser(driver=driver_exe)

    # Scrape the e-mails
    emails: set = browser.scrape_emails('https://www.randomlists.com/email-addresses?qty=50') #Give this a website with emails and it will return those emails
...
# Improvements
#   - Add a Scrape numbers method for phone numbers