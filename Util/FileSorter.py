...
def create_folder(path: str, extension: str) -> str:
    # Creats a folder that is named after the extension of the file passed in
...
def remove_empty_folders(source_path: str):
    #This function removes all empty folders
...
# Improvements:
#   - Create a tkinter app that allows the user to select the folder via a button